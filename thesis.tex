...
\captionfonts
\caption[Battlefield 3]{The photorealistic real-time graphics of Battlefield 3.\cite{bf3}}
\label{fig:bf3}
\includegraphics[width=\textwidth]{Images/Borderlands_2.png}
\captionfonts
\caption[Borderlands 2]{The comic book style of Borderlands 2.\cite{border2}}
...
\captionfonts
\caption[View Frustum]{A camera and its view frustum. A frustum is a pyramid with its top cut off. Objects within the frustum are visible.\cite{vfc-image}}
\label{fig:frustum}
\end{center}
\end{figure}
...
\captionfonts
\caption[Software Z Buffer Buffer]{The low resolution software z-buffer from a scene in Battlefield 3.\cite{culling-bf}}
\label{fig:softare-z}
\end{center}
\end{figure}
...
\captionfonts
\caption[Cry Engine Coverage Buffer]{The coverage buffer used in CryENGINE 3.  The red portions are the holes after reprojecting from previous frames to the current camera angle.\cite{cryengine3}}
...
\captionfonts
\caption[Query Cap of 3000]{Data for a scene with a query cap of 3000.}
...
\captionfonts
\caption[Query Cap of 4000]{Data for a scene with a query cap of 4000.}
