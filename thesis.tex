...
The space should be subdivided by the grid in a way that renders as few wastes objects as possible.
For example, if the camera is located inside a room, there should be as little overlap in cells between the current room and the room on the other side of the wall in order to avoid rendering as many objects on the other side of the wall as possible.
