...
This can negatively affect performance due to the number of queries being executed.
...
Higher numbers can also potentially induce spikes of lower framerate since cells that are now invisible are still considered visible and unnecessary objects are being rendered.
